...
const Island = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
  ...
  const dampingFactor = 0.95; // when you drag the island, how fast does it move (intertia)
  ...
  const handlePointerDown = (e) => {
    ...
    // set the lastX to the current clientX
  ...
  const handlePointerMove = (e) => {
    ...
    if (isRotating) {
      const clientX = e.touches ? e.touches[0].clientX : e.clientX;
      // delta often known as the change in x
  ...
  useFrame(() => {
    // if not rotating, apply damping factor to slow down the rotation (smoothly)
    if (!isRotating) {
